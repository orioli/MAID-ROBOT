...
#define __CosNotifyChannelAdmin_mProxyConsumer__
  ...
  {
  public:
    CosNotification::EventTypeSeq* obtain_subscription_types(ObtainInfoMode mode);
  ...
  public:
    ...
    virtual CosNotification::EventTypeSeq* obtain_subscription_types(ObtainInfoMode mode) = 0;
...
#define __CosNotifyChannelAdmin_mProxySupplier__
  ...
  {
  public:
    CosNotification::EventTypeSeq* obtain_offered_types(ObtainInfoMode mode);
    void validate_event_qos(const CosNotification::QoSProperties& required_qos, CosNotification::NamedPropertyRangeSeq_out available_qos);
    ProxyType MyType();
  ...
  public:
    ...
    virtual CosNotification::EventTypeSeq* obtain_offered_types(ObtainInfoMode mode) = 0;
    virtual void validate_event_qos(const CosNotification::QoSProperties& required_qos, CosNotification::NamedPropertyRangeSeq_out available_qos) = 0;
    virtual ProxyType MyType() = 0;
...
#define __CosNotifyChannelAdmin_mConsumerAdmin__
  ...
  {
  public:
    ProxySupplier_ptr get_proxy_supplier(ProxyID proxy_id);
    ProxySupplier_ptr obtain_notification_pull_supplier(ClientType ctype, ProxyID& proxy_id);
    ProxySupplier_ptr obtain_notification_push_supplier(ClientType ctype, ProxyID& proxy_id);
    void destroy();
    AdminID MyID();
  ...
  public:
    ...
    virtual ProxySupplier_ptr get_proxy_supplier(ProxyID proxy_id) = 0;
    virtual ProxySupplier_ptr obtain_notification_pull_supplier(ClientType ctype, ProxyID& proxy_id) = 0;
    virtual ProxySupplier_ptr obtain_notification_push_supplier(ClientType ctype, ProxyID& proxy_id) = 0;
...
#define __CosNotifyChannelAdmin_mSupplierAdmin__
  ...
  {
  public:
    ProxyConsumer_ptr get_proxy_consumer(ProxyID proxy_id);
    ProxyConsumer_ptr obtain_notification_pull_consumer(ClientType ctype, ProxyID& proxy_id);
    ProxyConsumer_ptr obtain_notification_push_consumer(ClientType ctype, ProxyID& proxy_id);
    void destroy();
    AdminID MyID();
    EventChannel_ptr MyChannel();
    InterFilterGroupOperator MyOperator();
  ...
  public:
    ...
    virtual ProxyConsumer_ptr get_proxy_consumer(ProxyID proxy_id) = 0;
    virtual ProxyConsumer_ptr obtain_notification_pull_consumer(ClientType ctype, ProxyID& proxy_id) = 0;
    virtual ProxyConsumer_ptr obtain_notification_push_consumer(ClientType ctype, ProxyID& proxy_id) = 0;
    virtual void destroy() = 0;
    virtual AdminID MyID() = 0;
    virtual EventChannel_ptr MyChannel() = 0;
    virtual InterFilterGroupOperator MyOperator() = 0;
...
#define __CosNotifyChannelAdmin_mEventChannel__
  ...
  {
  public:
    ConsumerAdmin_ptr new_for_consumers(InterFilterGroupOperator op, AdminID& id);
    SupplierAdmin_ptr new_for_suppliers(InterFilterGroupOperator op, AdminID& id);
    ConsumerAdmin_ptr get_consumeradmin(AdminID id);
    SupplierAdmin_ptr get_supplieradmin(AdminID id);
  ...
  public:
    ...
    virtual ConsumerAdmin_ptr new_for_consumers(InterFilterGroupOperator op, AdminID& id) = 0;
    virtual SupplierAdmin_ptr new_for_suppliers(InterFilterGroupOperator op, AdminID& id) = 0;
    virtual ConsumerAdmin_ptr get_consumeradmin(AdminID id) = 0;
    virtual SupplierAdmin_ptr get_supplieradmin(AdminID id) = 0;
...
#define __CosNotifyChannelAdmin_mEventChannelFactory__
  ...
  {
  public:
    EventChannel_ptr create_channel(const CosNotification::QoSProperties& initial_qos, const CosNotification::AdminProperties& initial_admin, ChannelID& id);
  ...
  public:
    ...
    virtual EventChannel_ptr create_channel(const CosNotification::QoSProperties& initial_qos, const CosNotification::AdminProperties& initial_admin, ChannelID& id) = 0;
    virtual ChannelIDSeq* get_all_channels() = 0;
    virtual EventChannel_ptr get_event_channel(ChannelID id) = 0;
