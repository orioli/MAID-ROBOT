...
#define __CosNotification_mQoSAdmin__
  ...
  public:
    ...
    void set_qos(const QoSProperties& qos);
    void validate_qos(const QoSProperties& required_qos, NamedPropertyRangeSeq_out available_qos);
  ...
  public:
    ...
    virtual void set_qos(const QoSProperties& qos) = 0;
    virtual void validate_qos(const QoSProperties& required_qos, NamedPropertyRangeSeq_out available_qos) = 0;
...
#define __CosNotification_mAdminPropertiesAdmin__
  ...
  public:
    ...
    void set_admin(const AdminProperties& admin);
  ...
  public:
    ...
    virtual void set_admin(const AdminProperties& admin) = 0;
