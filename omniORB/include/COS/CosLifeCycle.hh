...
#define __CosLifeCycle_mFactoryFinder__
  ...
  {
  public:
    Factories* find_factories(const Key& factory_key);
  ...
  public:
    ...
    virtual Factories* find_factories(const Key& factory_key) = 0;
...
#define __CosLifeCycle_mLifeCycleObject__
  ...
  {
  public:
    LifeCycleObject_ptr copy(FactoryFinder_ptr there, const Criteria& the_criteria);
    void move(FactoryFinder_ptr there, const Criteria& the_criteria);
    void remove();
  ...
  public:
    ...
    virtual LifeCycleObject_ptr copy(FactoryFinder_ptr there, const Criteria& the_criteria) = 0;
    virtual void move(FactoryFinder_ptr there, const Criteria& the_criteria) = 0;
...
#define __CosLifeCycle_mGenericFactory__
  ...
  {
  public:
    ::CORBA::Boolean supports(const Key& k);
    ::CORBA::Object_ptr create_object(const Key& k, const Criteria& the_criteria);
  ...
  public:
    ...
    virtual ::CORBA::Boolean supports(const Key& k) = 0;
    virtual ::CORBA::Object_ptr create_object(const Key& k, const Criteria& the_criteria) = 0;
