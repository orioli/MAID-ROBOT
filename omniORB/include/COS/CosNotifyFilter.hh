...
#define __CosNotifyFilter_mFilter__
  ...
  {
  public:
    ConstraintInfoSeq* add_constraints(const ConstraintExpSeq& constraint_list);
    void modify_constraints(const ConstraintIDSeq& del_list, const ConstraintInfoSeq& modify_list);
    ConstraintInfoSeq* get_constraints(const ConstraintIDSeq& id_list);
    ...
    void detach_callback(CallbackID callback);
  ...
  public:
    ...
    virtual ConstraintInfoSeq* add_constraints(const ConstraintExpSeq& constraint_list) = 0;
    virtual void modify_constraints(const ConstraintIDSeq& del_list, const ConstraintInfoSeq& modify_list) = 0;
    virtual ConstraintInfoSeq* get_constraints(const ConstraintIDSeq& id_list) = 0;
    ...
    virtual void detach_callback(CallbackID callback) = 0;
...
#define __CosNotifyFilter_mMappingFilter__
  ...
  {
  public:
    MappingConstraintInfoSeq* add_mapping_constraints(const MappingConstraintPairSeq& pair_list);
    void modify_mapping_constraints(const ConstraintIDSeq& del_list, const MappingConstraintInfoSeq& modify_list);
    MappingConstraintInfoSeq* get_mapping_constraints(const ConstraintIDSeq& id_list);
  ...
  public:
    ...
    virtual MappingConstraintInfoSeq* add_mapping_constraints(const MappingConstraintPairSeq& pair_list) = 0;
    virtual void modify_mapping_constraints(const ConstraintIDSeq& del_list, const MappingConstraintInfoSeq& modify_list) = 0;
    virtual MappingConstraintInfoSeq* get_mapping_constraints(const ConstraintIDSeq& id_list) = 0;
...
#define __CosNotifyFilter_mFilterAdmin__
  ...
  {
  public:
    FilterID add_filter(Filter_ptr new_filter);
    void remove_filter(FilterID filter);
    Filter_ptr get_filter(FilterID filter);
  ...
  public:
    ...
    virtual FilterID add_filter(Filter_ptr new_filter) = 0;
    virtual void remove_filter(FilterID filter) = 0;
    virtual Filter_ptr get_filter(FilterID filter) = 0;
